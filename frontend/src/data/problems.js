...
// Test cases
console.log(toArray(mergeTwoLists(toList([1,2,4]), toList([1,3,4])))); // Expected: [1,1,2,3,4,4]
console.log(toArray(mergeTwoLists(toList([]), toList([])))); // Expected: []
console.log(toArray(mergeTwoLists(toList([]), toList([0])))); // Expected: [0]`,
...
# Test cases
print(to_array(mergeTwoLists(to_list([1,2,4]), to_list([1,3,4]))))  # Expected: [1,1,2,3,4,4]
print(to_array(mergeTwoLists(to_list([]), to_list([]))))             # Expected: []
print(to_array(mergeTwoLists(to_list([]), to_list([0]))))            # Expected: [0]`,
      java: `class Solution {
    ...
    static String toArray(ListNode node) {
    ...
    public static void main(String[] args) {
        System.out.println(toArray(mergeTwoLists(toList(new int[]{1,2,4}), toList(new int[]{1,3,4})))); // Expected: [1, 1, 2, 3, 4, 4]
        System.out.println(toArray(mergeTwoLists(toList(new int[]{}), toList(new int[]{}))));            // Expected: []
        System.out.println(toArray(mergeTwoLists(toList(new int[]{}), toList(new int[]{0}))));           // Expected: [0]
    }
}`,
    },
    expectedOutput: {
    ...
    examples: [
      {
        ...
        output: "1",
        explanation: "11 = 11 (one coin).",
      },
      {
        input: "coins = [1,5,11], amount = 15",
        output: "3",
        explanation: "15 = 5 + 5 + 5 (three coins).",
      },
      {
...
// Test cases
console.log(coinChange([1,5,11], 11)); // Expected: 1
...
# Test cases
print(coinChange([1,5,11], 11))  # Expected: 1
...
print(coinChange([2], 3))        # Expected: -1`,
    ...
    public static void main(String[] args) {
        System.out.println(coinChange(new int[]{1,5,11}, 11)); // Expected: 1
